...
window.RollData = (function () {
  ...
  const EN = {
    ...
    HERO: {
      ...
      sub: "Open any agent. That session is the Supervisor: it routes planning, implementation, review, CI, and acceptance evidence through available agents and host-native sub-agents. You own the backlog, the PRs, and the release decision.",
    ...
    HOW: {
      ...
      layers: [
        ...
        },
        {
          ...
          body: "Delivers one Story through Designer, Builder, and Evaluator roles as host-native sub-agents.",
    ...
    QUICKSTART: {
      ...
      steps: [
        ...
        { cmd: "roll supervisor next", desc: "Let the current agent session choose the next card." },
        { cmd: "roll loop go", desc: "Start delivering cards from the backlog." },
        { cmd: "roll delta", desc: "Deliver one Story through host-native sub-agents." },
      ],
      notes: [
        "The agent session you are in is the Supervisor.",
    ...
    COMMANDS: {
      ...
      rows: [
        ...
        { cmd: "roll supervisor next", desc: "Choose the next card from the current session." },
        { cmd: "roll loop go", desc: "Start a session-driven run." },
        { cmd: "roll delta", desc: "Run a host-guided Delta Team delivery." },
  ...
  const ZH = {
    ...
    HERO: {
      ...
      sub: "打开任意 agent。这个会话就是 Supervisor：它在可用 agent 与宿主原生 sub-agents 之间路由规划、实现、评审、CI 与验收证据。你负责 backlog、PR 和发布决定。",
      install: "npm install -g @seanyao/roll",
      ctas: [
    ...
    HOW: {
      ...
      layers: [
        ...
        },
        {
          ...
          name: "Delta Unit",
          sub: "standard · verified · designed",
          body: "通过 Designer、Builder、Evaluator 等宿主原生 sub-agents 交付一张 Story。",
    ...
    QUICKSTART: {
      ...
      steps: [
        ...
        { cmd: "roll supervisor next", desc: "让当前 agent 会话选择下一张卡。" },
        { cmd: "roll loop go", desc: "开始从 backlog 逐张交付。" },
        { cmd: "roll delta", desc: "通过宿主原生 sub-agents 交付单张 Story。" },
      ],
      notes: [
        "当前 agent 会话就是 Supervisor。",
    ...
    COMMANDS: {
      ...
      rows: [
        ...
        { cmd: "roll supervisor next", desc: "从当前会话选择下一张卡。" },
        { cmd: "roll loop go", desc: "启动会话驱动运行。" },
        { cmd: "roll delta", desc: "运行 host-guided Delta Team 交付。" },

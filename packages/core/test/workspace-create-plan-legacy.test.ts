...
describe("WorkspaceCreationPlan", () => {
  it("parses the closed YAML config and produces one stable ordered create plan", () => {
    ...
    expect(plan.steps.map((step) => `${step.kind}:${step.action}:${step.target}`)).toEqual([
      ...
      "directory:created:/tmp/home/.roll/workspaces/ws-demo/features",
      "directory:created:/tmp/home/.roll/workspaces/ws-demo/evidence",
      ...
      "directory:created:/tmp/home/.roll/workspaces/ws-demo/runtime/tool-dumps",
      "directory:created:/tmp/home/.roll/workspaces/ws-demo/runtime/events",

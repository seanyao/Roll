...
export const v3Catalog: Catalog = {
  ...
  "delta.error.unknown_subcommand": {
    en: "roll delta: unknown subcommand '%s'. Try: prepare, validate, preflight, conclude, recover-held, status, help",
    zh: "roll delta：未知子命令 '%s'。可用：prepare、validate、preflight、conclude、recover-held、status、help",
  },
